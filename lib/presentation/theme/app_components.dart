...
final class AppComponents {
  ...
  static TextButtonThemeData textButtons(ColorScheme s) =>
      TextButtonThemeData(
  ...
  /// Inputs
  static InputDecorationTheme inputTheme(ColorScheme s) =>
  ...
  static NavigationBarThemeData navBar(ColorScheme s) => NavigationBarThemeData(
    ...
    iconTheme: WidgetStateProperty.resolveWith((states) {
      ...
      return IconThemeData(color: selected ? s.onSecondaryContainer : s.onSurfaceVariant);
    }),
  ...
  static SwitchThemeData switcher(ColorScheme s) =>
      SwitchThemeData(
        thumbColor: WidgetStateProperty.resolveWith(
              (states) => states.contains(WidgetState.selected) ? s.onPrimary : s.onSurfaceVariant,
        ),
        trackColor: WidgetStateProperty.resolveWith(
              (states) => states.contains(WidgetState.selected) ? s.primary : s.surfaceContainerHighest,
        ),
      );
